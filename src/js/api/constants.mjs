...
export function getAuctionEndpoints() {
  ...
  if (userName) {
    return {
      ...
      AUCTION_SINGLE_LISTINGS: `${AUCTION_PROFILES_ENDPOINT}/${userName.name}/listings?_seller=true&_bids=true`,
      AUCTION_SINGLE_WINS: `${AUCTION_PROFILES_ENDPOINT}/${userName.name}/wins?_seller=true&_bids=true&_listings=true`,
